...
[![x-cmd/install — freqtrade Code Quality Monitoring Repo Card](https://repo.x-cmd.io/freqtrade.svg?lang=zh)](https://x-cmd.com/install/freqtrade)
...
合计: **249,577** 行代码（覆盖前 5 种语言、共 **533** 个文件）。
...
- **Star**: 54,615 · **Fork**: 11,324 · **开放 issue**: 5,682 · **贡献者**: 337

## 累计统计

- **发布数**: 117 · **已合并 PR**: 6749 · **开放 PR**: 20 · **已关闭 issue**: 5659 · **开放 issue**: 23 · **提交数**: 32905
...
_数据快照: `data/card/260921.yml` · 2026-09-21T04:02:42Z._
